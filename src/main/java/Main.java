...
public class Main {
    ...
    public static HashMap getFieldValues(Profile p) {
    ...
    public static Output compareProfiles(Profile p1, Profile p2) {
        HashMap<String, Object> mapOne = getFieldValues(p1);
        HashMap<String, Object> mapTwo = getFieldValues(p2);
